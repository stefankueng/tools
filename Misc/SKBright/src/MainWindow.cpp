...
bool CMainWindow::RegisterAndCreateWindow()
{
    ...
    wcx.hIcon = LoadIcon(hResource, MAKEINTRESOURCE(IDI_SKBRIGHT));
    wcx.hbrBackground = NULL;
    wcx.lpszMenuName = NULL;
    wcx.hIconSm = LoadIcon(wcx.hInstance, MAKEINTRESOURCE(IDI_SKBRIGHT));
...
void CMainWindow::ShowTrayIcon()
{
    ...
    niData.uID = IDI_SKBRIGHT;
    niData.uFlags = NIF_ICON|NIF_MESSAGE|NIF_TIP|NIF_INFO;

    niData.hIcon = (HICON)LoadImage(hResource, MAKEINTRESOURCE(IDI_SKBRIGHT),
